...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            {
                return; // banco de dados já foi populado, o any valida se tem algum dado nas tabelas descritas acima
            }
            ...
            Seller s5 = new Seller(5, "Donald Blue", "Doni@gmail.com", new DateTime(2000, 1, 9), 4000.0, d3);
